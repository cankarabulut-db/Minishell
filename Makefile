...
SRC = main.c parsing/ps_token.c parsing/ps_control.c parsing/ps_start_and_fill.c parsing/ps_args.c parsing/ps_redirect.c \
		...
		execute/execute_signal.c execute/env_and_dollar.c execute/execute_builtin.c builtin/echo.c builtin/cd.c builtin/pwd.c builtin/export.c  builtin/export_utils.c  \
		builtin/env.c builtin/exit.c builtin/unset.c utils/utils1.c utils/utils2.c execute/execute_heredoc.c utils/utils4.c \
		utils/utils3.c parsing/extras.c execute/extras.c execute/extras2.c execute/extras3.c execute/extras4.c
